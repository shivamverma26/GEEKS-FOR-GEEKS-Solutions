<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-primes0042/1?page=1&company=Zoho&difficulty=Basic&sortBy=difficulty">Sum of primes</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Your task is to calculate sum&nbsp; of primes present as digits of given number N.</span></p>
